const hexelCache = 'hexel-app-v1.0.31';
const hexelCacheDynamic = 'hexel-app-dynamic-v0.31';
const hexelAssets = [
	'./pwa_index.html',
	'./pwa_about.html',
	'./script/bootstrap.bundle.min.js',
	'./script/jquery-3.5.1.min.js',
	'./script/hexel-pwa-firebase.js',
	'./script/pwa_ui.js',
...
self.addEventListener('activate', resp => {
	...
	resp.waitUntil(
		caches.keys().then(ver => {
			//console.log(ver);
			//sysNotif('Application has been updated to the latest version.', 'top');
