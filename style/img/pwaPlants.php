...
$pwaquery = "SELECT *, hexel_plant.plant_id AS plantID FROM hexel_plant INNER JOIN hexel_plant_desc ON hexel_plant.plant_id = hexel_plant_desc.desc_plantid WHERE hexel_plant_desc.desc_updated = 0;";
	...
	while($row = $pwaSQL->fetch_assoc()) {
		...
		<div class="card">
			...
			<div id="collapse-<?php echo $row['plantID']; ?>" class="collapse" aria-labelledby="<?php echo $row['plantID']; ?>" data-parent="#plantAccordion">
				<div class="card-body">
					<img src="./style/img/<?php echo $row['plant_image']; ?>" class="img-fluid" alt="<?php echo $row['plant_name']; ?>" loading="lazy">
					...
					<p class="m-0 p-0"><?php echo html_entity_decode($row['desc_plant']); ?></p>
					...
					<p class="m-0 p-0"><?php echo html_entity_decode($row['desc_guide']); ?></p>
					...
					<p class="m-0 p-0">PHP <?php echo $row['desc_price_min']; ?> - <?php echo $row['desc_price_max']; ?></p>
					<p class="m-0 p-0 text-muted"><small><?php if($row['desc_price_comment'] != 'NULL') { echo $row['desc_price_comment']; } ?></small></p>
